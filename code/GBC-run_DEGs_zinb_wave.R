...
# METHODS
# vect_method <- c('Combat','limma','MNN','scanorama','scGen','scmerge','seurat3','zinb_wave','scanorama','scGen','zinb_wave')
# vect_method <- c('Combat','limma','seurat3')
# vect_method <- c('Combat','Combat_seq', 'limma','MNN', 'seurat3', 'scmerge')
